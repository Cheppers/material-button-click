(function ($) {
  ...
  $.fn.mbClicker = function (options) {
    ...
    addClickerTo.unbind().on(iclicky, function (e) {
      ...
      // Stops ghost-click and bad placement of element on clicks that would
      // click the added element.
      ...
      // Animates circle to grow and fade at the same time as well as removing
      // the circle on animation complete.
      clicked.animate({
      ...
      // Animates the button itself with a slight opacity change to have a
      // better feel, button should not have the attr style applied to it as
      // this resets it.
